...
namespace org.GraphDefined.WWCP.eMIPv0_7_4.CPO
{
    ...
    /// </summary>
    public class SetSessionActionResponse : AResponse<SetServiceAuthorisationRequest,
                                                   SetSessionActionResponse>
    {
        ...
        public SetSessionActionResponse(SetServiceAuthorisationRequest       Request,
        ...
        public static SetSessionActionResponse Parse(SetServiceAuthorisationRequest                     Request,
        ...
        /// <param name="Request">The SetServiceAuthorisation request leading to this response.</param>
        /// <param name="SetSessionActionResponseXML">The XML to parse.</param>
        /// <param name="SetSessionActionResponse">The parsed SetServiceAuthorisation response.</param>
        /// <param name="CustomSendSetSessionActionResponseParser">An optional delegate to parse custom SetSessionActionResponse XML elements.</param>
        /// <param name="OnException">An optional delegate called whenever an exception occured.</param>
        ...
        /// </summary>
        /// <param name="SetSessionActionResponse1">A SetServiceAuthorisation response.</param>
        /// <param name="SetSessionActionResponse2">Another SetServiceAuthorisation response.</param>
        ...
        /// Compares two SetServiceAuthorisation responses for equality.
        /// </summary>
        /// <param name="SetSessionActionResponse">A SetServiceAuthorisation response to compare with.</param>
        /// <returns>True if both match; False otherwise.</returns>
                                                ...
                                                SetSessionActionResponse>
        {
            ...
            /// Create a new SetServiceAuthorisation response builder.
            /// </summary>
            /// <param name="SetSessionActionResponse">A SetServiceAuthorisation response.</param>
            /// <param name="CustomData">Optional custom data.</param>
