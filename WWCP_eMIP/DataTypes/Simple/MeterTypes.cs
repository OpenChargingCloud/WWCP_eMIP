...
namespace org.GraphDefined.WWCP.eMIPv0_7_4
{
                               ...
                               IComparable<MeterTypes>
    {
        ...
        #region (static)  MeterType_Id() <- Does reflection!

        static MeterTypes()
        {

            MeterTypes requeststatus;
            ...
            foreach (var _MethodInfo in typeof(MeterTypes).GetMethods())
            {
                    ...
                    _MethodInfo.GetParameters().Length == 0)
                {
                    ...
                    requeststatus = (MeterTypes) _MethodInfo.Invoke(Activator.CreateInstance(typeof(MeterTypes)), null);
        ...
        #region (private) MeterType_Id(Code, Description = null)
        ...
        #region TryParse(Text, out MeterType_Id)

        /// <summary>
        /// Try to parse the given string as a meter type.
        /// </summary>
        /// <param name="Text">A text representation of a meter type.</param>
        /// <param name="MeterType_Id">The parsed meter type.</param>
        public static Boolean TryParse(String Text, out MeterTypes MeterType_Id)
        {
            ...
            {
                MeterType_Id = default(MeterTypes);
                return false;
            }

            MeterType_Id = new MeterTypes(Value);
            return true;
        ...
        #region TryParse(Code, out MeterType_Id)
        ...
        /// <param name="Code">A numeric representation of a meter type.</param>
        /// <param name="MeterType_Id">The parsed meter type.</param>
        public static Boolean TryParse(Int32 Code, out MeterTypes MeterType_Id)
        {

            if (Lookup.TryGetValue(Code, out MeterType_Id))
                return true;

            MeterType_Id = new MeterTypes(Code);
            return true;
        ...
        #region IComparable<MeterType_Id> Members
        ...
        #region CompareTo(MeterType_Id)

        /// <summary>
        /// Compares two instances of this object.
        /// </summary>
        /// <param name="MeterType_Id">An object to compare with.</param>
        public Int32 CompareTo(MeterTypes MeterType_Id)
        {

            if ((Object) MeterType_Id == null)
                throw new ArgumentNullException(nameof(MeterType_Id),  "The given meter type must not be null!");

            return Code.CompareTo(MeterType_Id.Code);
        ...
        #region IEquatable<MeterType_Id> Members
        ...
        #region Equals(MeterType_Id)

        /// <summary>
        /// Compares two MeterType_Ids for equality.
        /// </summary>
        /// <param name="MeterType_Id">A meter type to compare with.</param>
        /// <returns>True if both match; False otherwise.</returns>
        public Boolean Equals(MeterTypes MeterType_Id)
        {

            if ((Object) MeterType_Id == null)
                return false;

            return Code.Equals(MeterType_Id.Code);
