    ...
    public class SetEVSESyntheticStatusRequest : ARequest<SetEVSESyntheticStatusRequest>
    {
                                       ...
                                       TimeSpan?                                               RequestTimeout      = null)
        {
            ...
            try
            {
                ...
                if (CustomSendSetEVSESyntheticStatusRequestParser != null)
            ...
            catch (Exception e)
            {
                ...
                OnException?.Invoke(DateTime.UtcNow, SetEVSESyntheticStatusRequestXML, e);
                                       ...
                                       TimeSpan?                                               RequestTimeout      = null)
        {
            ...
            {
                OnException?.Invoke(DateTime.UtcNow, SetEVSESyntheticStatusRequestText, e);
            }
        ...
        public static Boolean operator == (SetEVSESyntheticStatusRequest SetEVSESyntheticStatusRequest1, SetEVSESyntheticStatusRequest SetEVSESyntheticStatusRequest2)
        {
            ...
            if (((Object) SetEVSESyntheticStatusRequest1 == null) || ((Object) SetEVSESyntheticStatusRequest2 == null))
                return false;
