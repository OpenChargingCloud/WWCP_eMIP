...
namespace cloud.charging.open.protocols.eMIPv0_7_4.CPO
{
                                  ...
                                  IComparable
    {
        ...
        private async Task<PushEVSEDataResult>
            ...
            PushEVSEData(IEnumerable<IEVSE>   EVSEs,
...

        {
            ...
            //catch (Exception e)
            //{
            //    DebugX.LogException(e, nameof(WWCPCPOAdapter) + "." + nameof(OnPushEVSEDataWWCPRequest));
            //}
            ...
            //catch (Exception e)
            //{
            //    DebugX.LogException(e, nameof(WWCPCPOAdapter) + "." + nameof(OnPushEVSEDataWWCPResponse));
            //}
...

        {
            ...
            return await PushEVSEData(new IEVSE[] { EVSE },
                                      // ActionTypes.fullLoad,
            ...
            if (TransmissionType == TransmissionTypes.Enqueue)
            {
                ...
                try
                {
                    ...
                    if (LockTaken)
                    {
                        ...
                        result = PushEVSEDataResult.Enqueued(Id, this, null);
