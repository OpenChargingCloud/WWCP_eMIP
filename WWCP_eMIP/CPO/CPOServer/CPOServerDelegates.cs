...
namespace org.GraphDefined.WWCP.eMIPv0_7_4.CPO
{
    ...
    /// <summary>
    /// A delegate called whenever an 'set session action' request was received.
    /// </summary>
    /// <param name="LogTimestamp">The timestamp of the logging request.</param>
    /// <param name="RequestTimestamp">The timestamp of the request.</param>
    /// <param name="Sender">The sender of the request.</param>
    ...
    public delegate Task
        ...
        OnSetSessionActionRequestDelegate(DateTime                    LogTimestamp,
                                          ...
                                          String                      SessionActionParameter,
                                          String                      RelatedSessionEventId,
    ...
    /// <summary>
    /// A delegate called whenever a response to an 'set session action' request was sent.
    /// </summary>
    /// <param name="Timestamp">The timestamp of the request.</param>
    /// <param name="Sender">The sender of the request.</param>
    /// <param name="SenderId">The unique identification of the sender.</param>
